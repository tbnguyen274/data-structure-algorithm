...
int main() {
	cout << "------------------ Queue (Linked List version) ------------------\n";
	...
	do {
		...
		cout << "8 - Compare time execution of RELEASE using loop and recursive\n";
		cout << "9 - Compare time execution of COPY QUEUE using loop and recursive\n";
		...
		case 9:
		{
			...
			cout << endl;
			cout << "Time execution for COPY QUEUE using loop: " << duration1.count() << " microseconds.\n";
			cout << "Time execution for COPY QUEUE using recursive: " << duration2.count() << " microseconds.\n";
			break;
		}

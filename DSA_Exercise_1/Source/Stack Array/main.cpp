...
int main() {
	...
	do {
		...
		case 8:
		{
			...
			cout << endl;
			cout << "Time execution for COPY STACK using loop: " << elapsed1.count() << " microseconds.\n";
			cout << "Time execution for COPY STACK using recursive: " << elapsed2.count() << " microseconds.\n";
